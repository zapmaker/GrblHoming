...
/// LETARTARE : Command -> Command->lineEdit()
...
/// LETARTARE
	ui->lcdWorkNumberC->setEnabled(axisC);
	ui->lcdMachNumberC->setEnabled(axisC);
	ui->IncCBtn->setEnabled(axisC);
	ui->DecCBtn->setEnabled(axisC);
	ui->lblCJog->setEnabled(axisC);
/// <--
