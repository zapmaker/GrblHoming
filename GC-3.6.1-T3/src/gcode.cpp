...
/// LETARTARE  T3
// Slot for file Check, called  by  'MainWindow::checkCode()'
...
void GCode::pollPosWaitForIdle(bool checkMeasurementUnits)
{
        ...
        )
    {
        ...
        if (immediateQuit)
            return;
/// LETARTARE  T3 : to avoid loading too display
/// to review ...
      /*
...
/// LETARTARE  T3
        if (currLine) {
            ...
            emit setLinesFile(numLine, true);
